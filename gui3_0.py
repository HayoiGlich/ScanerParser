...
from rubic_module import RubiScraper
import pandas as pd
import os
...
class ScanerScraperGUI(QWidget):
    ...
    def init_ui(self):
        ...
        self.button_rubicon.clicked.connect(lambda: self.change_tab(2))

        self.button_settings = QPushButton('Настройки')
        self.button_settings.clicked.connect(lambda: self.change_tab(3))
